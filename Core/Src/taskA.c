...
void two_to_three2(void)
{
    ...
    turn_angle(turn_right, 15, 5000);   // 岔路口1右转
...
void go_home(uint8_t num)
{
    ...
    case 1:                               // 第一个红绿灯位绿灯
        ...
        tracking(4000, time_break, 3000); // 过路障
        // while(1)
        // {
        //     stop();
        // }
...
void eight_to_home(void)
{
    ...
    turn_angle(turn_left, 135, 5000); // 平台左转归正
    PLAY_ARRIVE_HOME();
    stop_time(3000);
}