...
void angle_pid_right(int16_t target);
void speed_pid(float target);

// extern PID_TypeDef pid_pitch;
extern PID_TypeDef motor_pid_speed[4];
extern PID_TypeDef motor_pid_position[4];
extern PID_TypeDef motor_pid_angle[4];
extern PID_TypeDef motor_pid[4];
extern PID_TypeDef imu_temp_pid;
